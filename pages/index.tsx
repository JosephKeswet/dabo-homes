          ...
          <div className='absolute top-8 md:top-20 lg:top-44 z-30  flex items-center justify-center flex-wrap gap-3'>
            ...
            <div className='lg:hidden w-[17rem] flex items-center gap-5 justify-center'>
                ...
                <Link href='/book' className='lg:hidden cursor-pointer flex  justify-center items-center gap-2 w-[6.7rem] mt-5 h-[1.6rem] rounded-[0.313rem] bg-[#DFAA5B]'>
                  <h1 className='text-xs text-white md:text-xs lg:text-xl'>Check Availability</h1>
                </Link>
            </div>
            <div className='lg:hidden cursor-pointer flex flex-col'>
              <h1 className='text-sm text-[#DFAA5B]  md:text-xs lg:text-xl'>Check In</h1>
              <input type="date" name="" id="" className='px-2 rounded-[0.313rem]'/>
            </div>
            <div className='lg:hidden cursor-pointer flex flex-col'>
              <h1 className='text-sm text-[#DFAA5B]  md:text-xs lg:text-xl'>Check Out</h1>
              <input type="date" name="" id="" className='px-2 rounded-[0.313rem]'/>
            </div>

            {/* Big Screens */}
            <div className='hidden lg:flex cursor-pointer items-center px-5 gap-2   md:rounded-[0.625rem] bg-[#FFFFFF]'>
              <h1 className='text-[0.313rem] text-[#00000080] opacity-50 md:text-xs lg:text-xl'>Check In</h1>
              <input type="date" name="" id="" className='flex justify-center items-center outline-none gap-2 w-[3.125rem] md:w-24  lg:w-36 h-4 md:h-8 lg:h-[3.755rem] rounded-[0.313rem] md:rounded-[0.625rem] bg-[#FFFFFF]'/>
            </div>
            <div className='hidden lg:flex cursor-pointer  items-center px-5 gap-2 w-[3.125rem] md:hidden  lg:w-[18rem] h-4 md:h-8 lg:h-[3.755rem] rounded-[0.313rem] md:rounded-[0.625rem] bg-[#FFFFFF]'>
              <h1 className='text-[0.313rem] text-[#00000080] opacity-50 md:text-xs lg:text-xl'>Check Out</h1>
              <input type="date" name="" id="" className='flex justify-center items-center outline-none gap-2 w-[3.125rem] md:w-24  lg:w-36 h-4 md:h-8 lg:h-[3.755rem] rounded-[0.313rem] md:rounded-[0.625rem] bg-[#FFFFFF]'/>
            </div>
            <Link href='/book' className='hidden lg:flex  cursor-pointer justify-center items-center gap-2 w-[3.125rem] md:w-24  lg:w-48 h-4 md:h-8 lg:h-[3.755rem] rounded-[0.313rem] md:rounded-[0.625rem] bg-[#DFAA5B]'>
